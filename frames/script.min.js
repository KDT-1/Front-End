...
jQuery(document).ready(function() {
    ...
    $(document).on("touchstart click", function(t) {
        0 != $(t.target).parents(".left-side-bar").length || $(t.target).is(".menu-icon, .menu-icon img") || ($(".left-side-bar").removeClass("open"),
...
function(n) {
    n.fn.vmenuModule = function(t) {
        ...
        (o = (e = n(this)).find("ul").parent("li").children("a")).attr("data-option", "off"),
        o.unbind("click").on("click", function() {
            ...
            "on" == t.attr("data-option") && (t.attr("data-option", "off"),
